...
namespace WebAPI.Controllers
{
    ...
    public class SyllabusController : ControllerBase
    {
        ...
        [SyllabusCustomAuthorize(new string[] { "FullAccess", "View", "Create", "Modify" })]
        [HttpGet("{syllabusId}")]
        ...
        [SyllabusCustomAuthorize(new string[] { "FullAccess", "Create" })]
        [HttpPost("{id}")]
        ...
        #region Update
        [SyllabusCustomAuthorize(new string[] { "FullAccess", "Modify" })]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateSyllabusAsync(UpdateSyllabusViewModel syllabusViewModel, int id)
        {
            try
            {
                var syllabus = await _syllabusService.UpdateSyllabusAsync(syllabusViewModel, id);
                if (syllabus == null)
                {

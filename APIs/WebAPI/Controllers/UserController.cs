...
namespace WebAPI.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        #region Detail
        [UserCustomAuthorize(new string[] { "FullAccess", "View", "Create", "Modify" })]
        [HttpGet("{id:int}")]
        ...
        [UserCustomAuthorize(new string[] { "FullAccess", "Create" })]
        [HttpPost]
        ...
        [UserCustomAuthorize(new string[] { "FullAccess", "Modify" })]
        [HttpPut("{id}")]

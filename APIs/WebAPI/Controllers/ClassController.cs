...
namespace WebAPI.Controllers
{
    ...
    public class ClassController : ControllerBase
    {
        ...
        [ClassCustomAuthorize(new string[] { "FullAccess", "Create" })]
        [HttpPost]
        ...
        [ClassCustomAuthorize(new string[] { "FullAccess", "View", "Create", "Modify" })]
        [HttpGet]
        ...
        [ClassCustomAuthorize(new string[] { "FullAccess", "Modify" })]
        [HttpPut("{id}")]
